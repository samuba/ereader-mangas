...
<li class="rounded-md shadow-sm inline-block m-2 bg-white ">
	<center
		class="sm:inline-block align-top bg-indigo-900 text-white text-sm font-medium rounded-l-md min-h-[13rem] max-h-[13rem] w-full sm:w-auto"
	>
	...
	<div
		class="sm:inline-block align-top min-h-[13rem] rounded-r-md border-t border-r border-b border-gray-200 bg-white -ml-[0.2rem] leading-snug w-96"
	>
		<div class="px-4 py-2 ">
